...
#Ejercicio 6
#con el coeficiente de correlacion
yi.hat <- predict(mod) #fitted(mod) o fitted.values(mod)
yi.real <- datos.ajuste$Yearly.Amount.Spent
R.2.corr <- cor(yi.real, yi.hat)^2
