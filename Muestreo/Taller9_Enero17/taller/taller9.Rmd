...
**Estadística II - Taller 09$\hspace{1.6cm}$Semestre: 2021-02**
...
b) La probabilidad de que una unidad en particular esté presente en la muestra es $\frac{n}{N}$.
...
e) Se realiza una encuesta en una red social, donde cualquiera que la vea puede responder y como
no se tiene certeza de quien va a responder, esto representa una selección aleatoria de la
...
para le error de estimación de la media del consumo diario de 1 galón.
...
a. ¿A cuánto equivalen los gastos totales en consumo que realizan los turistas en París?
b. ¿Cuál es el total de turistas que són extranjeros? Estime un intervalo de confianza.
c. Determine el tamaño de muestra mínimo necesario para estimar la propoción de extranjeros
que visitan París en un día con un límite para el error de estimación de 0.2 y una confianza de
95%